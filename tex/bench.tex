...
\begin{figure}[t]
	\begin{tikzpicture}
		\begin{groupplot}[
			...
			\myplot{ACMBlue}{mark=*}{../trie.fvs.0.merged};
            \addlegendentry{Indexed Trie}

			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.fvs.0.merged};
            \addlegendentry{\texttt{std::set}}

			\myplot{ACMRed}{densely dashed, mark=triangle*}{../immer.fvs.0.merged};
            \addlegendentry{\immer}

			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../0.dom.merged};
			...
			\myplot{ACMBlue}{mark=*}{../trie.beta.0.merged};
			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.beta.0.merged};
			\myplot{ACMRed}{densely dashed,mark=triangle*}{../immer.beta.0.merged};
			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../0.inl.merged};
            \addlegendentry{\llvm inline}
			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../0.opt.merged};
            \addlegendentry{\llvm inline + opt}

            \addplot [ACMGreen, smooth] {x * ln(x) / ln(2)};

			\nextgroupplot[title={Nesting Tree}]

			\myplot{ACMBlue}{mark=*}{../trie.nest.0.merged};
			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.nest.0.merged};
			...
			\myplot{ACMBlue}{mark=*}{../trie.fvs.1.merged};
			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.fvs.1.merged};
			\myplot{ACMRed}{densely dashed, mark=triangle*}{../immer.fvs.1.merged};
			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../1.dom.merged};

            \addplot [ACMGreen, smooth] {x * ln(x) / ln(2)};

			\nextgroupplot

			\myplot{ACMBlue}{mark=*}{../trie.beta.1.merged};
			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.beta.1.merged};
			\myplot{ACMRed}{densely dashed, mark=triangle*}{../immer.beta.1.merged};
			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../1.inl.merged};
			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../1.opt.merged};

            \addplot [ACMGreen, smooth] {x * ln(x) / ln(2)};

			\nextgroupplot

			\myplot{ACMBlue}{mark=*}{../trie.nest.1.merged};
			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.nest.1.merged};
			...
			\myplot{ACMBlue}{mark=*}{../trie.fvs.2.merged};
			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.fvs.2.merged};
			\myplot{ACMRed}{densely dashed, mark=triangle*}{../immer.fvs.2.merged};
			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../2.dom.merged};

            \addplot[ACMPurple, smooth,domain=1:1024,xshift=32] {(((x * ln(x) / ln(2))^3};
            \label{nlogn3}

			\nextgroupplot

			\myplot{ACMBlue}{mark=*}{../trie.beta.2.merged};
			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.beta.2.merged};
			\myplot{ACMRed}{densely dashed, mark=triangle*}{../immer.beta.2.merged};
			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../2.inl.merged};
			\myplot{ACMYellow}{densely dashed,mark=triangle*}{../2.opt.merged};

            \plot [ACMDarkBlue, smooth,domain=1:1024,xshift=32] {(x * ln(x) / ln(2))^2};
            \label{nlogn2}

			\nextgroupplot

			\myplot{ACMBlue}{mark=*}{../trie.nest.2.merged};
			\myplot{ACMOrange}{mark=square*,densely dotted}{../set.nest.2.merged};
			\myplot{ACMRed}{densely dashed, mark=triangle*}{../immer.nest.2.merged};

            \addplot[ACMDarkBlue, smooth,domain=1:1024,xshift=38] {(x * ln(x) / ln(2))^2};
    ...
    % \vspace{-2ex}
	\caption{%
        Performance in $\mu{}s$ (microseconds) of free variables computation, $\beta$-reduction, and nesting tree computation, dependent on three synthetic programs with an increasing number of loops using the indexed trie, \texttt{std::set} and \immer (lower is better).
