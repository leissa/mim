...
\begin{figure}[t]
	\begin{tikzpicture}
		\begin{groupplot}[
            ...
            \plot [ACMOrange, smooth,domain=1:1024,xshift=32] {(x * ln(x) / ln(2))^2};
            \label{nlogn2}

			\nextgroupplot

			\myplot{ACMPurple}{mark=*}{../trie.nest.2.merged};
			\myplot{ACMBlue}{mark=*}{../set.nest.2.merged};
			\myplot{ACMRed}{densely dashed, mark=triangle*}{../immer.nest.2.merged};

            \addplot [ACMPurple, smooth,domain=1:1024,xshift=34] {(x * ln(x) / ln(2))^3};
            \label{nlogn3}
